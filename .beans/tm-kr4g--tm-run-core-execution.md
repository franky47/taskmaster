...
- [ ] Claude's stdout is captured and printed to tm's stdout (S3.7)
- [ ] Claude's stderr and exit code are captured (S3.8)
- [ ] `tm run` ignores the enabled flag entirely (S3.9)
- [ ] Exit code reflects claude's exit code (S3.10)
